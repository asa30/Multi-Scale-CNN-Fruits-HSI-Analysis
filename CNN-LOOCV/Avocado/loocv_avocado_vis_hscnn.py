...
avocado_vis_loocv_results = LOOCV(avocado_vis_model, all_avocado_VIS, 12, 40, save_path="avocado_vis_hs_cnn_loocv", verbose=1)

print(f"Accuracy of LOOCV for HSCNN model tested on Avocado VIS: {np.mean(avocado_vis_loocv_results)}")
# save the results
np.save(os.path.join(working_dir, "avocado_vis_hs_cnn_loocv_results.npy"), avocado_vis_loocv_results)